...
@[simp] theorem bor_false (b : Bool) : (b || false) = b  := by cases b <;> rfl
@[simp] theorem bor_true (b : Bool) : (b || true) = true := by cases b <;> rfl
@[simp] theorem false_bor (b : Bool) : (false || b) = b  := by cases b <;> rfl
@[simp] theorem true_bor (b : Bool) : (true || b) = true := by cases b <;> rfl
@[simp] theorem bor_self (b : Bool) : (b || b) = b       := by cases b <;> rfl
